...
const experienceData = [
  {
    ...
    period: "2023 - Present",
    description:
      "Developed responsive web applications using React, Next.js, and Tailwind CSS. Collaborated with UI/UX designers to implement pixel-perfect interfaces.",
  ...
  },
  {
    ...
    period: "2022 - 2023",
    description:
      "Created user interfaces and experiences for web and mobile applications. Conducted user research and usability testing.",
  ...
  },
  {
    ...
    period: "2021 - 2022",
    description:
      "Assisted in the development of web applications. Learned modern frontend technologies and best practices.",
